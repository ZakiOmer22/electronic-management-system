                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage Catogeries</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Manage Catogeries Details</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        $ret = "SELECT * FROM categories ORDER BY created_at DESC";
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Action Buttons -->
                                                        <a href="els_view_catogeries.php?id=<?php echo $row->id; ?>" class="badge badge-success">
                                                        ...
                                                        <!-- Report Button -->
                                                        <a href="els_report_catogeries.php?id=<?php echo $row->id; ?>" class="badge badge-warning">

                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->category_name; ?></td> <!-- Assuming categories table has 'category_name' -->
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="els_edit_product.php?id=<?php echo $row->id; ?>" class="badge badge-primary">
                                                            <i class="mdi mdi-pencil"></i> Edit
                                                        </a>
                                                        <a href="delete_product.php?id=<?php echo $row->id; ?>" class="badge badge-danger">
                                                            <i class="mdi mdi-trash-can-outline"></i> Delete
                                                        </a>
                                                        <a href="els_report_products.php?id=<?php echo $row->id; ?>" class="badge badge-danger">
                                                            <i class="mdi mdi-trash-can-outline"></i> Report
                                                        </a>
                                                    </td>
                                                </tr>
                                            </tbody>

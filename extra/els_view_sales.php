                            ...
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <?php
                                        /*
            *get details of all sales
        */
                                        $ret = "SELECT * FROM sales ORDER BY RAND()";
                                        // SQL code to get sales randomly
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_sale.php?id=<?php echo $row->id; ?>" class="badge badge-success">
